...
Public Module Helpers
    ...
    Public Function FromHex(hex As String) As Drawing.Color
...
#End Region
    ...
    Private _border As Drawing.Color = FromHex("#435363")
    Public Property Border As Drawing.Color
        Get
            Return _border
        End Get
...
Public Class VelocityTag
    ...
    Private _border As Drawing.Color = FromHex("#2c3e50")
    Public Property Border As Drawing.Color
        Get
            Return _border
        End Get
...
Public Class VelocityProgressBar
    ...
    Private _border As Drawing.Color = FromHex("#485e75")
    Public Property Border As Drawing.Color
        Get
            Return _border
        End Get
    ...
    Private _progressColor As Drawing.Color = FromHex("#2c3e50")
    Public Property ProgressColor As Drawing.Color
        Get
    ...
    Protected Overrides Sub OnPaint(e As PaintEventArgs)
        ...
        If _showPercent Then
            ...
            g.DrawRectangle(New Pen(Drawing.Color.Black), 0, 0, Width - 35, Height - 1)
        ...
        Else
            ...
            g.DrawRectangle(New Pen(Drawing.Color.Black), 0, 0, Width - 1, Height - 1)
        End If
    End Sub
End Class
